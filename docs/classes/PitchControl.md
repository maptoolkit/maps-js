[Maptoolkit JS](../README.md) / PitchControl
...
> **new PitchControl**(`options?`: [`PitchControlOptions`](../type-aliases/PitchControlOptions.md)): `PitchControl`

#### Parameters

| Parameter | Type | Description |
| ------ | ------ | ------ |
| `options?` | [`PitchControlOptions`](../type-aliases/PitchControlOptions.md) | Options for configuring the pitch control. |
