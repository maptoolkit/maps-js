...
> **boxzoomcancel**: [`MapLibreZoomEvent`](MapLibreZoomEvent.md)
...
> **boxzoomend**: [`MapLibreZoomEvent`](MapLibreZoomEvent.md)
...
> **boxzoomstart**: [`MapLibreZoomEvent`](MapLibreZoomEvent.md)
...
> **cooperativegestureprevented**: [`MapLibreEvent`](MapLibreEvent.md)\<`WheelEvent` \| `TouchEvent`\> & `object`
...
> **data**: [`MapDataEvent`](MapDataEvent.md)

Fired when any map data loads or changes. See [MapDataEvent](MapDataEvent.md) for more information.
...
> **dataabort**: [`MapDataEvent`](MapDataEvent.md)
...
> **dataloading**: [`MapDataEvent`](MapDataEvent.md)
...
> **drag**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `undefined`\>
...
> **dragend**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `undefined`\>
...
> **dragstart**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `undefined`\>
...
> **idle**: [`MapLibreEvent`](MapLibreEvent.md)
...
> **load**: [`MapLibreEvent`](MapLibreEvent.md)
...
#### See
 ...
 - [Draw GeoJSON points](https://maplibre.org/maplibre-gl-js/docs/examples/geojson-markers/)
...
> **move**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `WheelEvent` \| `undefined`\>
...
> **moveend**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `WheelEvent` \| `undefined`\>
...
> **movestart**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `WheelEvent` \| `undefined`\>
...
> **pitch**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `undefined`\>
...
> **pitchend**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `undefined`\>
...
> **pitchstart**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `undefined`\>
...
> **projectiontransition**: [`MapProjectionEvent`](MapProjectionEvent.md)
...
> **remove**: [`MapLibreEvent`](MapLibreEvent.md)
...
> **render**: [`MapLibreEvent`](MapLibreEvent.md)
...
> **resize**: [`MapLibreEvent`](MapLibreEvent.md)
...
> **rotate**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `undefined`\>
...
> **rotateend**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `undefined`\>
...
> **rotatestart**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `undefined`\>
...
> **sourcedata**: [`MapSourceDataEvent`](MapSourceDataEvent.md)
...
> **sourcedataabort**: [`MapSourceDataEvent`](MapSourceDataEvent.md)
...
> **sourcedataloading**: [`MapSourceDataEvent`](MapSourceDataEvent.md)
...
> **styledata**: [`MapStyleDataEvent`](MapStyleDataEvent.md)
...
> **styledataloading**: [`MapStyleDataEvent`](MapStyleDataEvent.md)
...
> **styleimagemissing**: [`MapStyleImageMissingEvent`](MapStyleImageMissingEvent.md)
...
[Generate and add a missing icon to the map](https://maplibre.org/maplibre-gl-js/docs/examples/add-image-missing-generated/)

***

### terrain

> **terrain**: [`MapTerrainEvent`](MapTerrainEvent.md)
...
> **webglcontextlost**: [`MapContextEvent`](MapContextEvent.md)
...
> **webglcontextrestored**: [`MapContextEvent`](MapContextEvent.md)
...
> **zoom**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `WheelEvent` \| `undefined`\>
...
> **zoomend**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `WheelEvent` \| `undefined`\>
...
> **zoomstart**: [`MapLibreEvent`](MapLibreEvent.md)\<`MouseEvent` \| `TouchEvent` \| `WheelEvent` \| `undefined`\>
